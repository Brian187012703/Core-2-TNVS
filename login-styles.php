...
.promo-section {
    ...
    position: relative;
    background-image: radial-gradient(circle at 1% 1%, rgba(0, 230, 118, 0.05) 1px, transparent 0);
...
.stat-item {
    padding: 20px 16px;
    background: linear-gradient(135deg, var(--color-surface) 0%, rgba(0, 230, 118, 0.03) 100%);
    border-radius: 10px;
...
.stat-item:hover {
    ...
    background: linear-gradient(135deg, var(--color-surface) 0%, rgba(0, 230, 118, 0.08) 100%);
}
...
.password-toggle:hover {
    color: var(--color-neon-accent) !important;
}
...
.modal-actions-contact .modal-btn {
    width: auto;
    padding: 10px 20px;
}
...
.toast-notification {
    ...
    border-left: 5px solid var(--color-neon-accent);
    color: var(--color-text-primary);
    display: flex;
    align-items: center;
    gap: 10px;
