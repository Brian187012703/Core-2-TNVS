    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (e) => {
            ...
            if (email.length > 0 && password.length > 0) {
                ...
                // Set a flag in local storage to simulate being logged in (optional but helpful)
                localStorage.setItem('tnvs_logged_in', 'true');

                // **STEP 3: Perform the Redirect**
                // IMPORTANT: Use the correct file name here (index\.php or dashboard\.php)
                const dashboardFile = 'dashboard\.php'; // Adjust this if you renamed it to 'dashboard\.php'
                ...
                // You would typically replace 'alert' with a styled error message on the page.
            }
        });
    }
